...
While I didn't expect the hospital to provide a way to sync my appointments to my calendar, I did think my iPhone should offer an easier way for me to do this on the go. And this is where [Voice Inbox][vb] began to take shape.

---

Though I mentioned Siri in the post, [Voice Inbox is not Siri]({% link _projects/voice-inbox/voice-inbox-is-not-siri.md %}).
