...
A business owner's value output to the society is reached by the enterprise as a whole, which is generally accomplished by all the employees of the enterprise. The employees accomplish the actual value output for the business owner, but the biggest beneficiary is the business owner[^5], in which case the business owner's enterprise (employees, team) is its leverage.
...
It's not an exaggeration to say that in a traditional business, a software engineer's results may bring value to one or more businesses, but in a business that utilizes the Internet as leverage, the engineer's results are amplified by the Internet and serve people likely nationwide or even worldwide, which is why software engineers in Internet businesses are paid more - - They create more value[^8].
