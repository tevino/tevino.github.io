...
meta:
  - name: YunoHost
    description: |
        ...
        [What is YunoHost? | Yunohost Documentation][1]

        [1]: https://doc.yunohost.org/en/whatsyunohost?utm_source=tevinzhang.com
  - name: borg
    description: |
        Deduplicating archiver with compression and encryption

        [BorgBackup – Deduplicating archiver with compression and authenticated encryption][1]
        ...
        [1]: https://www.borgbackup.org?utm_source=tevinzhang.com
---
...
[od]: https://web.archive.org/web/20230629205306/https://yunohost.org/en/backup/include_exclude_files?utm_source={{ site.utm_source }}
