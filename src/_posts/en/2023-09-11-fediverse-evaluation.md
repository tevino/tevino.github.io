...
With Twitter becoming yet another TikTok and increasing control over content[^1] [^2], I started using the fediverse as an alternative. 
...
[![Fediverse total users]({% link /assets/2023-10_fediverse_users.png %} "Fediverse total users")][fedi_users]
[![Mastodon total and active users]({% link /assets/2023-10_mastodon_users.png %} "Mastodon total and active users")][mas_users]
...
Let's face it - if Twitter can fail, so can fediverse servers[^5]. Self-hosting gives me full control of my data[^3] [^4] and removes one more [dependency][ti] out of my life.
...
2. Multi-language[^7] post support so me and followers can subscribe to certain languages
...
7. Low resource usage for sustainability[^6]
...
[^1]: Twitter demotes content they don't like, for example when mentioning competitors like Mastodon.
[^2]: [An Audacious Plan to Halt the Internet's Enshittification - Cory Doctorow][1]
[^3]: This is a general preference of myself and here's [a post]({% post_url en/2023-07-25-data %}) about it.
[^4]: Links in my old tweets broke when I need them, see [this][2] about it.
[^5]: Another perspective is that the fediverse servers are smaller so the chance of being acquired and getting overloaded is also smaller, but I like to be prepared.
[^6]: Can run on a $5 VPS.
[^7]: I post in English and Chinese. One workaround is to use separate accounts for each language, but it took too much effort in my experience.


[single]: https://jvns.ca/blog/2023/08/11/some-notes-on-mastodon/?utm_source={{ site.utm_source }}
[pleroma_mr]: https://git.pleroma.social/pleroma/pleroma/-/merge_requests/3822?utm_source={{ site.utm_source }}
[gts_bug]: https://github.com/superseriousbusiness/gotosocial/issues/1277?utm_source={{ site.utm_source }}
[ti]: https://sive.rs/ti?utm_source={{ site.utm_source }}#why
[elk]: https://elk.zone?utm_source={{ site.utm_source }}
[fedi_users]: https://fediverse.observer/stats?utm_source={{ site.utm_source }}
[mas_users]: https://mastodon-analytics.com?utm_source={{ site.utm_source }}

[1]: https://www.youtube.com/watch?v=q118B_QdP2k&utm_source={{ site.utm_source }}
[2]: https://www.theverge.com/2023/8/20/23838823/twitter-x-deleted-pictures-links-2014-metadata-t-co-shortener?utm_source={{ site.utm_source }}
