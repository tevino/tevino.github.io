...
[^ptl]: 这是一个好例子：[写纯文本文件 - Derek Sivers][2]
[^pte]: 你可以在为实际使用而制作的任何操作系统上找到（纯）文本编辑器。几十年前的设备可以读写纯文本。
[^format]: 要考虑更多方面：公开标准化、无限制、良好文档化和自文档化。
[^ms]: 现代的Windows 10可以运行20年前为Windows 95或NT4编译的二进制文件。[Windows如何保持20多年的二进制兼容性？][1]
...
[1]: https://softwareengineering.stackexchange.com/q/359914?utm_source={{ site.utm_source }}
[2]: https://sive.rs/plaintext?utm_source={{ site.utm_source }}
